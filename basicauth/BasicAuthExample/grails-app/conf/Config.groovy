...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'uk.ac.shu.webarch.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'uk.ac.shu.webarch.UserRole'
grails.plugin.springsecurity.authority.className = 'uk.ac.shu.webarch.Role'
